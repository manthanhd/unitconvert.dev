...
// 140 CSS Named Colors with their hex values
export const cssNamedColors: Record<string, string> = {
  // Basic colors
  black: '#000000',
  silver: '#c0c0c0',
  gray: '#808080',
...
export const colorUnits: Unit[] = [
  ...
  },
  {
    ...
    categoryId: 'color',
    name: 'Named',
    abbreviations: ['named', 'name'],
    aliases: ['css color', 'color name', 'named color', 'css named color'],
  },
  {
    id: 'color-lab',
    categoryId: 'color',
    name: 'LAB',
    abbreviations: ['lab'],
    aliases: ['lab color', 'cielab', 'l*a*b*', 'lab()'],
  },
  {
    id: 'color-lch',
    categoryId: 'color',
